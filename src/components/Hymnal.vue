<template>
  ...
  <v-container grid-list-md style=" white-space: pre-line; font-weight: bold; text-align: left;" v-touch="{
      left: () => swipe('Left'),
      right: () => swipe('Right')
    }">
...
export default {
  ...
  methods: {
    ...
    swipe (direction) {
        if(direction === 'left')
           document.getElementById("prevhymn").click();
        else
          document.getElementById("nexthymn").click();
    }
  },
};
</script>
